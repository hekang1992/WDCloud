...
extension MonthPeopleViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard self.peopleArray.count != 0 else { return UITableViewCell() }
...
extension MonthPeopleViewController: JXPagingViewListViewDelegate {
