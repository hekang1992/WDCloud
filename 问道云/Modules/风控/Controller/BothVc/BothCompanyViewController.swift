//
//  BothCompanyViewController.swift
//  问道云
//
...
class BothCompanyViewController: WDBaseViewController {
...
extension BothCompanyViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        twoLabel.attributedText = GetRedStrConfig.getRedStr(from: "\(rcount)+", fullText: "全部动态\(rcount)+", colorStr: "#FF4444")
...
extension BothCompanyViewController: JXSegmentedListContainerViewListDelegate, JXSegmentedListContainerViewDataSource {
