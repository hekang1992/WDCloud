//
//  PeopleRiskMoreDetailViewController.swift
//  问道云
//
...
class PeopleRiskMoreDetailViewController: WDBaseViewController {
    ...
    lazy var riskHeadView: PeopleRiskDetailHeadView = {
        let riskHeadView = PeopleRiskDetailHeadView()
...
/** 网络数据请求 */
extension PeopleRiskMoreDetailViewController {
...
extension PeopleRiskMoreDetailViewController: UITableViewDelegate, UITableViewDataSource {
