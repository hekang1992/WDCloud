//
//  PeopleMySelfRiskViewController.swift
//  问道云
//
...
class PeopleMySelfRiskViewController: WDBaseViewController {
    ...
    lazy var lawView: CompanyLawListView = {
        ...
        lawView.oneBlock = { model1, model2 in
            let riskSecondVc = PeopleRiskMoreDetailViewController()
...
extension PeopleMySelfRiskViewController: UITableViewDelegate, UITableViewDataSource {
...
extension PeopleMySelfRiskViewController: JXPagingViewListViewDelegate {
