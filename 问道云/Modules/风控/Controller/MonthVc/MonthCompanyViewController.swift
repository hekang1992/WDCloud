//
//  MonthCompanyViewController.swift
//  问道云
//
...
extension MonthCompanyViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        twoLabel.attributedText = GetRedStrConfig.getRedStr(from: "\(rcount)+", fullText: "本月新动态\(rcount)+", colorStr: "#FF4444")
...
extension MonthCompanyViewController: JXSegmentedListContainerViewListDelegate, JXSegmentedListContainerViewDataSource {
