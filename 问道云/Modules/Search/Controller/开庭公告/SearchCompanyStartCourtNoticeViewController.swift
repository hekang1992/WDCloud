//
//  SearchCompanyStartCourtNoticeViewController.swift
//  问道云
//
...
class SearchCompanyStartCourtNoticeViewController: WDBaseViewController {
...
extension SearchCompanyStartCourtNoticeViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let model = self.allArray[indexPath.row]
        let pageUrl = "\(base_url)/litigation-risk/judicial-notices"
...
extension SearchCompanyStartCourtNoticeViewController {
    ...
    private func getSanctionInfo() {
        ...
        man.requestAPI(params: dict,
                       pageUrl: "/riskmonitor/illegalPunish/getHearingNotice",
