//
//  SearchStartCourtNoticeViewController.swift
//  问道云
//
...
class SearchStartCourtNoticeViewController: WDBaseViewController {
    ...
    lazy var headView: PropertyHeadView = {
        ...
        headView.headView.titlelabel.text = "开庭公告"
        return headView
    }()
...
extension SearchStartCourtNoticeViewController: UITextFieldDelegate {
...
extension SearchStartCourtNoticeViewController: JXPagingViewDelegate, JXSegmentedViewDelegate {
...
extension SearchStartCourtNoticeViewController {
    ...
    private func getHotsSearchInfo() {
        ...
        group.enter()
        getLastHistroyInfo(from: "15") { [weak self] modelArray in
            self?.historyArray = modelArray
            group.leave()
        }
        
        group.enter()
        getLastHotsInfo(from: "15") { [weak self] modelArray in
