...
class BeneficialDetailViewController: WDBaseViewController {
...
/** 网络数据请求 */
extension BeneficialDetailViewController {
...
extension BeneficialDetailViewController: UITableViewDelegate, UITableViewDataSource {
