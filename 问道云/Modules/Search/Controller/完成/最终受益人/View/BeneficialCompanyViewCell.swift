//
//  BeneficialCompanyViewCell.swift
//  问道云
//
...
class BeneficialCompanyViewCell: BaseViewCell {
...
//        }
        ...
        model.asObservable().subscribe(onNext: { [weak self] model in
            ...
            let count = String(model.listCompany?.count ?? 0)
            descLabel.attributedText = GetRedStrConfig.getRedStr(from: count, fullText: "共担任\(count)家企业最终受益人,详情如下:")
            let relatedOrgList = model.listCompany ?? []
...
extension BeneficialCompanyViewCell {
