//
//  SearchJudicialAuctioniewViewController.swift
//  问道云
//
...
class SearchJudicialAuctioniewViewController: WDBaseViewController {
    ...
    lazy var headView: PropertyHeadView = {
        ...
        headView.headView.titlelabel.text = "司法拍卖"
        return headView
    }()
    ...
    lazy var companyVc: SearchCompanyJudicialAuctioniewViewController = {
        let companyVc = SearchCompanyJudicialAuctioniewViewController()
        return companyVc
    }()
    
    lazy var peopleVc: SearchPeopleJudicialAuctioniewViewController = {
        let peopleVc = SearchPeopleJudicialAuctioniewViewController()
        return peopleVc
    }()
...
extension SearchJudicialAuctioniewViewController: UITextFieldDelegate {
...
extension SearchJudicialAuctioniewViewController: JXPagingViewDelegate, JXSegmentedViewDelegate {
...
/** 网络数据请求 */
extension SearchJudicialAuctioniewViewController {
    ...
    private func getHotsSearchInfo() {
        ...
        group.enter()
        getLastSearchInfo(from: "16") { [weak self] modelArray in
        ...
        group.enter()
        getLastHistroyInfo(from: "16") { [weak self] modelArray in
            self?.historyArray = modelArray
            group.leave()
        }
        
        group.enter()
        getLastHotsInfo(from: "16") { [weak self] modelArray in
