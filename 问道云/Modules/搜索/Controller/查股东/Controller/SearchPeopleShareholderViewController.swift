//
//  SearchPeopleShareholderViewController.swift
//  问道云
//
...
class SearchPeopleShareholderViewController: WDBaseViewController {
...
extension SearchPeopleShareholderViewController: UITableViewDelegate, UITableViewDataSource {
...
extension SearchPeopleShareholderViewController: SkeletonTableViewDataSource {
    func collectionSkeletonView(_ skeletonView: UITableView, cellIdentifierForRowAt indexPath: IndexPath) -> ReusableCellIdentifier {
        return "SearchPeopleShareholderCell"
    }
    ...
    func collectionSkeletonView(_ skeletonView: UITableView, skeletonCellForRowAt indexPath: IndexPath) -> UITableViewCell? {
        let cell = skeletonView.dequeueReusableCell(withIdentifier: "SearchPeopleShareholderCell", for: indexPath) as! SearchPeopleShareholderCell
        cell.selectionStyle = .none
        return cell
    }
...
extension SearchPeopleShareholderViewController {
    ...
    private func searchListInfo() {
        ...
        man.requestAPI(params: dict,
                       pageUrl: "/firminfo/v2/person/shareholder-search",
...
extension SearchPeopleShareholderViewController: JXPagingViewListViewDelegate {
