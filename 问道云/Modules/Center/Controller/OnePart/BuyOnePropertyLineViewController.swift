//
//  BuyOnePropertyLineViewController.swift
//  问道云
//
...
class BuyOnePropertyLineViewController: WDBaseViewController {
    
    var serviceType: String = ""
    
    var moneyStr = "支付 ¥9 开通财产线索权益（基础版）"
    
    var money1Str = "支付 ¥19 开通财产线索权益（专业版）"
    ...
    lazy var ctImageView: UIImageView = {
        ...
        ctImageView.image = UIImage(named: "propertylingimge")
        return ctImageView
    }()
    
    lazy var descImageView: UIImageView = {
        let descImageView = UIImageView()
        descImageView.image = UIImage(named: "peifofnakln")
    ...
    lazy var bImageView: UIImageView = {
        ...
        bImageView.image = UIImage(named: "dfjapimge")
        return bImageView
    }()
...
extension BuyOnePropertyLineViewController {
