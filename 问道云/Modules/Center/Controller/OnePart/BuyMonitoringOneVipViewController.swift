//
//  BuyMonitoringOneVipViewController.swift
//  问道云
//
...
class BuyMonitoringOneVipViewController: WDBaseViewController {
    
    var serviceType: String = ""
    
    var moneyStr = "支付 ¥9 开通风控权益（基础版）"
    
    var money1Str = "支付 ¥19 开通风控权益（专业版）"
...
extension BuyMonitoringOneVipViewController {
