//
//  SearchPeopleDeadbeatDetailViewController.swift
//  问道云
//
...
class SearchPeopleDeadbeatDetailViewController: WDBaseViewController {
...
extension SearchPeopleDeadbeatDetailViewController: UITableViewDelegate, UITableViewDataSource {
